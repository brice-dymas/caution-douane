...
describe('Service Tests', () => {
    describe('Banque Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Banque(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Banque', async () => {
            ...
            it('should update a Banque', async () => {
                const returnedFromService = Object.assign(
                    {
                        numeroBanque: 'BBBBBB',
                        nomBanque: 'BBBBBB',
            ...
            it('should return a list of Banque', async () => {
                const returnedFromService = Object.assign(
                    {
                        numeroBanque: 'BBBBBB',
                        nomBanque: 'BBBBBB',
            ...
            it('should delete a Banque', async () => {
