...
import { IPieceJointe, PieceJointe } from 'app/shared/model/piece-jointe.model';
...
describe('Service Tests', () => {
    describe('PieceJointe Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new PieceJointe(0, 'AAAAAAA', 'image/png', 'AAAAAAA', 'AAAAAAA');
        });
