...
describe('Service Tests', () => {
    describe('Caution Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Caution(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Caution', async () => {
            ...
            it('should update a Caution', async () => {
                const returnedFromService = Object.assign(
                    {
            ...
            it('should return a list of Caution', async () => {
                const returnedFromService = Object.assign(
                    {
                        numeroCaution: 'BBBBBB',
                        numeroDossier: 'BBBBBB',
            ...
            it('should delete a Caution', async () => {
