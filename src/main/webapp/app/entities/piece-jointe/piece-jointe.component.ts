...
export class PieceJointeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.pieceJointeService
            ...
            .subscribe(
                (res: HttpResponse<IPieceJointe[]>) => this.paginatePieceJointes(res.body, res.headers),
    ...
    trackId(index: number, item: IPieceJointe) {
        return item.id;
    }
    ...
    protected paginatePieceJointes(data: IPieceJointe[], headers: HttpHeaders) {
