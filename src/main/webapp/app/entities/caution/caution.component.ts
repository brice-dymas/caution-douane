...
export class CautionComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.cautionService
            ...
            .subscribe(
                (res: HttpResponse<ICaution[]>) => this.paginateCautions(res.body, res.headers),
    ...
    registerChangeInCautions() {
        this.eventSubscriber = this.eventManager.subscribe('cautionListModification', response => this.loadAll());
    }
